...
import ReactNative, { Image, StyleSheet, View, Platform } from "react-native";
...
export default class EntryDetail extends React.Component {
  render() {
    let santitize = safeHtml(
      this.props.navigation.state.params.entry.body,
      config
    );
