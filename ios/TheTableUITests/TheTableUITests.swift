...
class TheTableUITests: XCTestCase {
    ...
    func testExample() {
      ...
      snapshot("05About")
      app/*@START_MENU_TOKEN@*/.otherElements["  Give"]/*[[".otherElements.matching(identifier: \" TONIGHT  WILL I . . . \/\/ Part 2  Tue Mar 13 2018 WILL I . . . \/\/ Part 1  Mon Mar 05 2018 The Table is designed to help young adults find and follow jesus and build lasting relationships with others. We talk about big concepts, interview awesome people, serve, and eat together every month. Address  Riverside Community Church - Parkside Campus \\n800 3rd Street  \\nOakmont, PA 15139  \\n\\nContact \\nEmail:  info@thetableinbetween.org \\nPhone: 412.828.2488 \\nTimes  \\nWeekly: Tuesdays, 7PM - 8:30PM  \\nFamily Meal (last Tuesday of the month): 7PM - 8:30PM    Home   Live   Notes   Give   About About\")",".otherElements.matching(identifier: \" TONIGHT  WILL I . . . \/\/ Part 2  Tue Mar 13 2018 WILL I . . . \/\/ Part 1  Mon Mar 05 2018 The Table is designed to help young adults find and follow jesus and build lasting relationships with others. We talk about big concepts, interview awesome people, serve, and eat together every month. Address  Riverside Community Church - Parkside Campus \\n800 3rd Street  \\nOakmont, PA 15139  \\n\\nContact \\nEmail:  info@thetableinbetween.org \\nPhone: 412.828.2488 \\nTimes  \\nWeekly: Tuesdays, 7PM - 8:30PM  \\nFamily Meal (last Tuesday of the month): 7PM - 8:30PM    Home   Live   Notes   Give   About\")",".otherElements.matching(identifier: \"  Home   Live   Notes   Give   About\").otherElements[\"  Give\"]",".otherElements[\"  Give\"]"],[[[-1,3],[-1,2],[-1,1,2],[-1,0,1]],[[-1,3],[-1,2],[-1,1,2]],[[-1,3],[-1,2]]],[0]]@END_MENU_TOKEN@*/.tap()
      snapshot("04Give", timeWaitingForIdle: 60)
